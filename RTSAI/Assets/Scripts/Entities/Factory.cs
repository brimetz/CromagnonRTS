...
{
    [SerializeField]
    public FactoryDataScriptable FactoryData = null;
    ...
    protected override void Awake()
    {
        ...
        HPBar.SetMaxHealth(FactoryData.MaxHP);
        Vision.Team = GetTeam();
        Vision.Range = FactoryData.RangeVision;
    ...
    void CheckUnderAttack()
    {
        ...
        else if (Timer >= TimerUnderAttack)
        {
            IsUnderAttack = false;
            Timer = 0f;
        }
    ...
    Unit BuildUnit()
    {
        ...
        if (Mathf.FloorToInt(SpawnCount / FactoryData.NbSpawnSlots) > 2)
            SpawnCount = 0;
